// Code From: https://gist.github.com/richardblondet/ce87a397ef669d4d25dd21ea02b9dda1

var SHEET_ID = "YOUR SPREADSHEET ID Found in the URL";
...
function Read( request, table ) {
  ...
  return response().json({
    success: true,
    data: _read( table, request_id, filter_type, filter_obj, filter_condition, "api" )
  });
...
* javascript object
*/
function _read( sheet, id, filter_type, filter_obj, filter_condition, call_from = "script" ) {
